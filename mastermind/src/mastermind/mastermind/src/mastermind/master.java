...
public class master {
	...
	public static void main(String[] args) {
		...
		Node guess6n = m.child(guess5);
		int guess6[] = { guess6n.c1, guess6n.c2, guess6n.c3, guess6n.c4 };
		System.out.println("------------------------------\nchild minerror:\n" +guess6[0] + "," + guess6[1] + "," + guess6[2] + "," + guess6[3] + ":  ");
		Node guess7n	=m.child(guess6);
		int guess7[] = { guess7n.c1, guess7n.c2, guess7n.c3, guess7n.c4 };
		System.out.println("------------------------------\nchild minerror:\n" +guess7[0] + "," + guess7[1] + "," + guess7[2] + "," + guess7[3] + ":  ");
		Node guess8n=m.child(guess7);
		int guess8[] = { guess8n.c1, guess8n.c2, guess8n.c3, guess8n.c4 };
		System.out.println("------------------------------\nchild minerror:\n" +guess8[0] + "," + guess8[1] + "," + guess8[2] + "," + guess8[3] + ":  ");
		m.child(guess8);
		...
		// System.out.println(guess6[0] + "," + guess[1] + "," + guess5[2] + "," +
		// guess5[3] + ": ");
